...
# python3 -c "import secrets; open('/etc/roost-ng/django-SECRET_KEY', 'w', encoding='utf8').write(secrets.token_urlsafe(50))"
...
if os.path.exists(SECRET_KEY_FILE):
    with open(SECRET_KEY_FILE, 'r', encoding='utf8') as secret_key_file:
